...
(function($) {
    ...
    $.fn.tipr = function(options) {
        ...
        return this.each(function() {
            ...
            var tipr_cont = '.tipr_container_' + settings.mode;
            ...
            $(this).hover(
                function() {
                    ...
                    if ($(this).attr('data-mode')) {
                        ...
                        tipr_cont = '.tipr_container_' + mode;
                    }

                    var out = '<div class="tipr_container_' + mode + '"><div class="tipr_point_' + mode + '"><div class="tipr_content">' + $(this).attr('data-tip') + '</div></div></div>';
                    ...
                    $(tipr_cont).fadeIn(settings.speed);
                },
                function() {
                    $(tipr_cont).remove();
                }
